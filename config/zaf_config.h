...
// <i> Default: 0x0000
#define ZAF_CONFIG_PRODUCT_ID  8
...
// <i> Default: 0
#define ZAF_CONFIG_GENERIC_TYPE  GENERIC_TYPE_SENSOR_MULTILEVEL
...
#define ZAF_CONFIG_SPECIFIC_TYPE  SPECIFIC_TYPE_ROUTING_SENSOR_MULTILEVEL
